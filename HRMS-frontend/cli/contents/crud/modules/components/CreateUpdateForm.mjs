...
type TComponentProps = {
  ...
  initialData?: T${pascalCaseName}Schema['Doc'];
...
const ${pascalCaseName}CreateUpdateForm = ({ onSubmit, isSubmitting, initialData }: TComponentProps) => {
...
export default ${pascalCaseName}CreateUpdateForm;
